...
function validateRunner(value: unknown): AgentRunnerConfig | undefined {
	...
	if (runner.adapter !== undefined) throw new Error("Runtime agent definition external-cli runner 'adapter' is no longer supported; run the command directly without an adapter.");
